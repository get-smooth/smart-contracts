...
/// @title  ERC721Mint
/// @notice Mint a NFT token using the ERC721 contract
contract ERC721Mint is BaseScript {
    function run() external payable virtual broadcast {
        address nftAddress = vm.envAddress("NFT_CONTRACT");
        TestERC721(nftAddress).mint();
    }
}
